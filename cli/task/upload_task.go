...
// UploadedFilesSet maps from the original path to fileids
...
func (t MynahUploadTask) ExecuteTask(mynahServer *server.MynahClient,
	...
	for i := 0; i < len(t.FilePaths); i++ {
		...
		//create a mapping from the original path to the assigned fileid
		uploadedSet[uploadRes.originalPath] = uploadRes.fileid
	}
